...
export function AppleReceiptEmail({firstname, clientAddress, email,lastName, invoiceDate, orderID, laundromat, delivery, serviceName, total, price}: AppleReceiptEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>{laundromat} Receipt</Preview>
        ...
        <Container style={container}>
          ...
          <Section>
            <Text style={cupomText}>
              Save 10% on all your laundry and dry cleaning by using teillo as your laundry service provider.
             
              <sup style={supStyle}>1</sup>{' '}
               <br />
              <Link href="www.teillo.com">
                Download the teillo app and use in minutes
              </Link>
          ...
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn} colSpan={2}>
                ...
                <Text style={informationTableValue}>{firstname + " "+ lastName}</Text>
                <Text style={informationTableValue}>{clientAddress}</Text>
                
              </Column>
            </Row>
          </Section>
          <Section style={productTitleTable}>
            <Text style={productsTitle}>{laundromat}</Text>
          </Section>
          <Section>
            ...
            <Column style={{ paddingLeft: '22px' }}>
              <Text style={productTitle}>{serviceName}</Text>
              <Text style={productDescription}>{serviceName} @ {price}/kg</Text>
              <Text style={productDescription}>Due {delivery}</Text>
              <Link
            ...
            <Column style={productPriceWrapper} align="right">
              <Text style={productPrice}>R {price.toFixed(2)}</Text>
            </Column>
          </Section>
          ...
          <Section align="right">
            ...
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>R {price.toFixed(2)}</Text>
            </Column>
          </Section>
